...
import "https://github.com/FelixxMerc/NFTStaking/blob/main/Rewards.sol";
import "https://github.com/FelixxMerc/NFTStaking/blob/main/Collection.sol";



contract multipoolNFTstaking is Ownable, IERC721Receiver {

  struct vaultInfo {
        Collection nft;
        FireRewardsToken token;
        string name;
  }
